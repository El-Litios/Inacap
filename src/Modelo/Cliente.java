...
public class Cliente {
    ...
    public Cliente(int cod_cliente, String rut_cliente, String nom_cliente, String direc1_cliente, String direc2_cliente, String tel1_cliente, String tel2_cliente, String co_cliente, Date fecn_cliente) {
    ...
    public Cliente(int cod_cliente, String nom_cliente) {
        this.cod_cliente = cod_cliente;
        this.nom_cliente = nom_cliente;
    }
