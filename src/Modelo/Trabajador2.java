 ...
 * @author Mark-
 */
public class Trabajador2 extends FacturaCompra2 {
    ...
    public Trabajador2(String nom_traba, int prec_iva, Date fec_compra, String nom_dist) {
        super(prec_iva, fec_compra, nom_dist);
